...
function save_flight_value(question, value) {
  ...
  api.fn.answers({Q1_show:  value.Show});
  api.fn.answers({Q1_airline_name:   value.Airline}); //airline name
  api.fn.answers({Q1_airline:   value.AirlineCode}); //airline code
  api.fn.answers({Q1_flight_number:   value.Flight});
  api.fn.answers({Q1_destination:   value.Dest});
  api.fn.answers({Q1_destination_name: value.DestName});
